...
const NavLinks = ({OpenNav}) => {
  ...
  return (
    <>
    {/* hidden lg:flex */}
      <ul className={`transition-all duration-300 ease-in-out ${OpenNav? "left-0" : "left-[-332px]"} absolute  w-[320px] h-full z-[1000] bg-white lg:relative lg:left-auto lg:w-auto lg:h-auto lg:z-auto lg:bg-transparent lg:flex`} >
        <Link className="px-[18px] py-0 flex items-center justify-center hover:text-[#01455d] cursor-pointer">
          <li className="w-full py-[12px] pr-[15px] pl-[26px] lg:w-auto lg:py-0 lg:pr-0 lg:pl-0">Home</li>
        </Link>
        <Link className="px-[18px] py-0 flex items-center justify-center hover:text-[#01455d] cursor-pointer">
          <li className="w-full py-[12px] pr-[15px] pl-[26px] lg:w-auto lg:py-0 lg:pr-0 lg:pl-0">Evoting</li>
        </Link>
        <Link className="px-[18px] py-0 flex items-center justify-center hover:text-[#01455d] cursor-pointer">
          <li className="w-full py-[12px] pr-[15px] pl-[26px] lg:w-auto lg:py-0 lg:pr-0 lg:pl-0">Donation</li>
        </Link>
        <Link className="px-[18px] py-0 flex items-center justify-center hover:text-[#01455d] cursor-pointer">
          <li className="w-full py-[12px] pr-[15px] pl-[26px] lg:w-auto lg:py-0 lg:pr-0 lg:pl-0">Events</li>
        </Link>
        <Link className="px-[18px] py-0 flex items-center justify-center hover:text-[#01455d] cursor-pointer">
          <li className="w-full py-[12px] pr-[15px] pl-[26px] lg:w-auto lg:py-0 lg:pr-0 lg:pl-0">Results</li>
        </Link>
        <Link className="px-[18px] py-0 flex items-center justify-center hover:text-[#01455d] cursor-pointer">
          <li className="w-full py-[12px] pr-[15px] pl-[26px] lg:w-auto lg:py-0 lg:pr-0 lg:pl-0">Blog</li>
        </Link>
        <Link className="px-[18px] py-0 flex items-center justify-center hover:text-[#01455d] cursor-pointer">
      ...
      <div className="w-full h-[80px] bg-white text-[14px] font-medium transition-all duration-500 flex items-center justify-center">
        <div className="container flex justify-between lg:justify-between mx-10 px-10 ">
          ...
          <div className="left">
            ...
            <div  className="flex justify-center items-center  lg:hidden"  onClick={toggleNavFunction}>
              <RxHamburgerMenu />
            </div>
          </div>
        </div>
